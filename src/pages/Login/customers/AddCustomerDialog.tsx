...
const AddCustomerDialog = ({ open, onOpenChange, form, onSubmit }: AddCustomerDialogProps) => (
  <Dialog open={open} onOpenChange={onOpenChange}>
    <DialogContent>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit((data) => { onSubmit(data); onOpenChange(false); })} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
          <FormField
            name="name"
          ...
          <DialogFooter>
            ...
            <Button type="submit" variant="default" disabled={!form.formState.isValid} className="bg-blue-600 text-white hover:bg-blue-700">Add</Button>
          </DialogFooter>
        </form>
      </Form>
    </DialogContent>
